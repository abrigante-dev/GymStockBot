...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://j56h0vfzj7.execute-api.us-east-1.amazonaws.com/ccbdab';
    ...
    apigClient.uploadPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['objectKey', 'x-amz-meta-customLabels'], ['body']);
        ...
        var uploadPutRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['objectKey', 'x-amz-meta-customLabels']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
